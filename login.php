...
if(!empty($_POST))
{
    if($error_flg == 0)
    {
            ...
            //データを1件取得する
            $sth = $db->pdoObject->prepare($sql, array(PDO::ATTR_CURSOR => PDO::CURSOR_FWDONLY));
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form method="post" action="login.php">
      <input type="text" id="login" class="fadeIn second" name="name" placeholder="メールアドレス:mywork01と入力してください">
      <input type="password" id="password" class="fadeIn third" name="password" placeholder="パスワード:mywork01と入力して下さい">
    ...
    <form method="post" action="login.php">
      ...
      <?php } ?>        
      <input type="text" id="login" class="fadeIn second" name="name" placeholder="メールアドレス:mywork01と入力して下さい">
